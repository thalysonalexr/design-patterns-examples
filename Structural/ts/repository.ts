export namespace repositoryExample {
  ...
  class ProductRepository extends RepositoryDefault<Product, number | string> {
    ...
    public getProductByTitle(title: string): Product | null {
